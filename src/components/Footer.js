      ...
      <Container>
        <div className={classes.wrapper}>
          ...
          >
            <Typography>
              <Link href="/hakkimizda" passHref={true}>
                <LinkMui className={classes.link}>HAKKIMIZDA</LinkMui>
              </Link>
              <Link href="/contact" passHref={true}>
                <LinkMui className={classes.link}>İLETİŞİM</LinkMui>
              </Link>
              <Link href="/contact" passHref={true}>
          ...
          <div className={`${classes.item} ${classes.right} ${classes.social}`}>
            <a
              href="https://instagram.com/tokyaysut"
              target="_blank"
              rel="noreferrer"
              className={classes.link}
            >
            ...
            <a
              href="https://facebook.com/tokyaysut"
              target="_blank"
              rel="noreferrer"
              className={classes.link}
            >
